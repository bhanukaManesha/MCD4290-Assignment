...
function updateOutput(aString){
    ...
    if (aString!==undefined){
        ...
        output+="<h2 style=\" display : block; text-align:left; background-color:darkblue; color:#fff;margin-top:10px;padding-left:90px;\">"+aString+"</h2>"
    }else{
        // If no argument is provided the temporary length of the sequence is shown
        output += "<h2 style=\" display : block; text-align :left; background-color:darkblue; color:#fff;margin-top:10px;padding-left:165px;\">"+sequence.tempLengthOfSequence+"</h2>";
    }
    
    // Adding the current level to the output
    output += "<h1 style=\" display : block; text-align : left; background-color:darkblue; color:#fff; padding-left:100px\">Level " + level.currentLevel + "</h1><br>";
    
    
    // Adding the length of the sequence to the output
    output +="<div class=\"demo-card-wide mdl-card mdl-shadow--2dp\" style=\"display:inline-block;margin-left:15px;height:80px;text-align:left;\" ><div class=\"mdl-card__title\" style=\"background-color:darkblue;color:#fff; height:150px\"><h2 class=\"mdl-card__title-text\">Length of Sequence</h2></div><div class=\"mdl-card__supporting-text\" style=\"font-size:3em\">"+sequence.lengthOfSequence+"</div></div><br><br>";
